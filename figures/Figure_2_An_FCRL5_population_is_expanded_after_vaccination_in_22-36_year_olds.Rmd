...
knitr::opts_chunk$set(echo = F, tidy = T, warning = F, message = F, fig.width = 8, fig.height = 11.5, tidy.opts=list(width.cutoff=60))
```
...
library(png)
library(grid)
panelg <- readPNG("../cohort_2016_17/data/FlowValidation/Figure 2G placeholder.png")
g <- rasterGrob(panelg, interpolate=TRUE)
panelg <- qplot(1:10, 1:10, geom="blank") +
...
# cowplot::plot_grid(panelg, FCRL5panel, FCRL5panelByDay, ncol = 3, labels = c("G", "H", "I")),
